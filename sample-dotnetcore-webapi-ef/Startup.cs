...
namespace sample_dotnetcore_webapi_ef
{
    public class Startup
    {
        ...
        {                        
            services.AddDbContext<BooksDbContext>(options => options.UseNpgsql(Configuration.GetConnectionString("POSTGRESQL")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = ".NET Core WebApi with Entity Framework Core (to PostgreSQL)", Version = "v1" });
            });
